  ...
  <script>
    ...
    async toggleFeatured(id) {
        try {
            ...
            throw new common_1.HttpException('Failed to update story', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    async deleteWaitlist(id) {
        try {
            ...
            throw new common_1.HttpException('Failed to delete waitlist entry', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    escapeHtml(text) {
        if (!text)
